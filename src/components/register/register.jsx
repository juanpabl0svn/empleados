  ...
  return (
    <div className="mx-auto max-w-[432px] bg-white rounded-md shadow-lg drop-shadow-md">
      <div className="px-4 py-3 flex justify-between">
        <div>
          <h2 className="font-bold" style="font-size: 32px">
            Sign Up
          </h2>
          <p className="text-gray-500" style="font-size: 15px">
            It's quick and easy.
          </p>
        </div>
      ...
      <div className="px-4 pt-3 pb-6 space-y-3">
        ...
        <div>
          <p className="text-gray-600" style="font-size: 11px">
          ...
          <p className="text-gray-600 mt-4" style="font-size: 11px">
